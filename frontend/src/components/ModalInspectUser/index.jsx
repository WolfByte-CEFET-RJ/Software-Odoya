...
const ModalInspectUser = ({user, closeModal}) => {
    ...
    async function updateUser() {
        ...
        if(userData.name === '' || userData.email === '') {
            toast.error("Um dos campos está vazio!");
        } else {
            try {
    ...
    const loading = (func) => {
        ...
        switch(func) {
            case 'promote': promoteUser(); break;
            ...
            <div className={modalInspect.overlay}>
                <div className={modalInspect.body}>
                    ...
                    <div className={modalInspect.options}>
                        ...
                        <button className={modalInspect.optionsSaveProfile} disabled={lock} onClick={() => loading('update')}>
                            <MdFolder size={25}/>
                            <span>Salvar</span>
                        </button>
                    </div>
